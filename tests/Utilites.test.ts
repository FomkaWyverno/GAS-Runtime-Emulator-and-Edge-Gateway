...
describe('Utilities.computeDigest', () => {
    ...
    it('Test MD5 Compare string', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.MD5, stringTest);
        const expected = [-79, 10, -115, -79, 100, -32, 117, 65, 5, -73, -87, -101, -25, 46, 63, -27];
        expect(result).toEqual(expected);
    });

    it('Test SHA1 Compare string', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_1, stringTest);
        const expected = [10, 77, 85, -88, -41, 120, -27, 2, 47, -85, 112, 25, 119, -59, -40, 64, -69, -60, -122, -48];
        expect(result).toEqual(expected);
    });

    it('Test SHA256 Compare string', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_256, stringTest);
    ...
    it('Test SHA384 Compare string', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_384, stringTest);
    ...
    it('Test SHA512 Compare string', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_512, stringTest);
    ...
    it('Test MD5 Compare numbers', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.MD5, numbersTest);
        const expected = [-123, -106, -63, -81, 85, -79, 75, 123, 50, 1, 18, -108, 79, -53, -123, 54];
        expect(result).toEqual(expected);
    });

    it('Test SHA1 Compare numbers', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_1, numbersTest);
        const expected = [-74, -59, 17, -121, 59, 7, -89, 53, 19, 22, 27, 20, 45, 52, 75, 123, -124, 92, -84, -17];
        expect(result).toEqual(expected);
    });

    it('Test SHA256 Compare numbers', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_256, numbersTest);
    ...
    it('Test SHA384 Compare numbers', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_384, numbersTest);
    ...
    it('Test SHA512 Compare numbers', () => {
        const result = Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_512, numbersTest);
...
describe("Utilities.base64Encode", () => {
    ...
    it("Test encode string", () => {
        const result = Utilities.base64Encode(stringTest);
        const expected = 'SGVsbG8gdGVzdCE='
        expect(result).toEqual(expected);
    });

    it('Test encode numbers', () => {
        const result = Utilities.base64Encode(numbersTest);
...
describe("Utilities.base64Decode", () => {
    ...
    it("Test decode string", () => {
        const result = String.fromCharCode(...Utilities.base64Decode(stringTestBase64));
        const expected = 'Hello test!'
        expect(result).toEqual(expected);
    });

    it('Test decode numbers', () => {
        const result = Utilities.base64Decode(numbersTestBase64);
...
describe("Utilities.base64EncodeWebSafe", () => {
    ...
    it("Test encode string", () => {
        const result = Utilities.base64EncodeWebSafe(stringTest);
        const expected = 'ID4_Kys='
        expect(result).toEqual(expected);
    });

    it('Test encode numbers', () => {
        const result = Utilities.base64EncodeWebSafe(numbersTest);
        const expected = '-_-_';
        expect(result).toEqual(expected);
    });
});
...
describe("Utilities.base64DecodeWebSafe", () => {
    ...
    it("Test decode string", () => {
        const result = String.fromCharCode(...Utilities.base64DecodeWebSafe(stringTest));
        const expected = " >?++"
        expect(result).toEqual(expected);
    });

    it('Test decode numbers', () => {
        const result = Utilities.base64DecodeWebSafe(numbersTest);
