/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc5d2eb0e0df6271a2c89744a392cf3d)
// Runtime types generated with workerd@1.20260630.1 2026-07-02 nodejs_compat
interface __BaseEnv_Env {
	KV_STORE: KVNamespace;
	"telegram-bot-secret": "твій_дефолтний_токен_або_заглушка";
	"telegram-bot-gas-url": "https://script.google.com/...";
	"telegram-bot-host-ping-expiration-ttl": "300";
	"host-ping-token": "супер_секретний_пінг_токен";
	"host-request-token": "host-request-token";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "telegram-bot-secret" | "telegram-bot-gas-url" | "telegram-bot-host-ping-expiration-ttl" | "host-ping-token" | "host-request-token">> {}
}
